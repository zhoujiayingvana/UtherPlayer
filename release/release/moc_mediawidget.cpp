...
QT_MOC_LITERAL(8, 108, 10), // "mousePress"
QT_MOC_LITERAL(9, 119, 13), // "hideBottomBar"
QT_MOC_LITERAL(10, 133, 13), // "mediaLuminAdd"
QT_MOC_LITERAL(11, 147, 13) // "mediaLuminSub"

    },
    "MediaWidget\0full_screenButton_clicked\0"
    "\0bottomBarHide\0volumeWidgetHide\0"
    "bottomBarShow\0wheelMoved\0QWheelEvent*\0"
    "mousePress\0hideBottomBar\0mediaLuminAdd\0"
    "mediaLuminSub"
};
...
void MediaWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->hideBottomBar(); break;
        case 7: _t->mediaLuminAdd(); break;
        case 8: _t->mediaLuminSub(); break;
        default: ;
        }
        ...
        {
            using _t = void (MediaWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MediaWidget::mousePress)) {
                *result = 5;
                return;
            }
        }

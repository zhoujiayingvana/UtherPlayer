...
QT_MOC_LITERAL(1, 13, 16), // "clickIndexSignal"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 20) // "sltCellDoubleClicked"

    },
    "searchResult\0clickIndexSignal\0\0"
    "sltCellDoubleClicked"
};
...
void searchResult::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clickIndexSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->sltCellDoubleClicked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (searchResult::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&searchResult::clickIndexSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject searchResult::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_searchResult.data,
    qt_meta_data_searchResult,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void searchResult::clickIndexSignal(int _t1)
{

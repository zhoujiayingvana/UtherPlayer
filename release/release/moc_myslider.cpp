...
QT_MOC_LITERAL(1, 9, 9), // "timerStop"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 10) // "timerStart"

    },
    "MySlider\0timerStop\0\0timerStart"
};
...
void MySlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySlider::timerStop)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MySlider::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MySlider::timerStart)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MySlider::timerStop()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MySlider::timerStart()
{

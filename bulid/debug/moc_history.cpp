...
QT_MOC_LITERAL(1, 8, 19), // "doubleClickedSignal"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 20), // "historyDoubleClicked"
QT_MOC_LITERAL(4, 50, 13), // "deleteHistory"
QT_MOC_LITERAL(5, 64, 11) // "playHistory"

    },
    "history\0doubleClickedSignal\0\0"
    "historyDoubleClicked\0deleteHistory\0"
    "playHistory"
};
...
void history::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->doubleClickedSignal(); break;
        case 1: _t->historyDoubleClicked(); break;
        case 2: _t->deleteHistory(); break;
        case 3: _t->playHistory(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&history::doubleClickedSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (history::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&history::historyDoubleClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void history::doubleClickedSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void history::historyDoubleClicked()
{
